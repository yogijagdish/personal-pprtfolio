    ...
    <section className="bg-backgroundColour text-textColour px-5 py-32 md:py-60 scroll-smooth" id="home">
      <div className="container mx-auto grid md:grid-cols-2 md:gap-96 items-center md:justify-between">
        <div className="hero-info pb-5 md:pb-0">
          ...
          <motion.div className="pt-8" variants={buttonVariant} initial="hidden" whileHover="show">
            <button className="font-bodyFont font-bold text-xl h-10 w-52 bg-navColour rounded-lg hover:text-black">
              <a href="../images/Resume/jagdishcv.pdf" download="jadishcv.pdf">
                Download Resume
              </a>
            </button>
          </motion.div>
          <div className="flex py-8">
            <motion.div variants={buttonVariant} initial="hidden" whileHover="show">
        ...
        <div>
          <motion.img src={jd} alt="gif images" variants={imageVariant} initial="hidden" whileHover="show" />
        </div>
      </div>
    </section>
  );
